...
partial struct BuildingBloodcircleSystem : ISystem {
    ...
    public void OnUpdate(ref SystemState state) {
        ...
        foreach ((
            RefRW<BuildingBloodcircle> buildingBloodcircle,
            ...
            buildingBloodcircle.ValueRW.onUnitQueueChanged = true;
        }
        ...
        foreach ((
            ...
            if (buildingBloodcircle.ValueRO.activeUnitType != spawnUnitTypeDynamicBuffer[0].unitType) {
                buildingBloodcircle.ValueRW.activeUnitType = spawnUnitTypeDynamicBuffer[0].unitType;

                UnitTypeSO activeUnitTypeSO = 
                    GameAssets.Instance.unitTypeListSO.GetUnitTypeSO(buildingBloodcircle.ValueRO.activeUnitType);

                buildingBloodcircle.ValueRW.progressMax = activeUnitTypeSO.progressMax;
            }

            buildingBloodcircle.ValueRW.progress += SystemAPI.Time.DeltaTime;

            if (buildingBloodcircle.ValueRO.progress < buildingBloodcircle.ValueRO.progressMax) {
                continue;
            }

            buildingBloodcircle.ValueRW.progress = 0f;
            ...
            this.SpawnFormation(ref state, unitTypeSO, entitiesReferences, localTransform.ValueRO.Position, buildingBloodcircle.ValueRO.rallyPositionOffset);
        }
    }
